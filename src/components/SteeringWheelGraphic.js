  ...
  return (
    <div className="w-full text-3xl text-center flex flex-col justify-center font-mono text-zinc-200">
      ...
      <div className="grid border-[1px] border-zinc-700 grid-cols-5 grid-rows-2">
        <div className="col-span-1 text-cyan-300 border-[1px] border-zinc-700 row-span-1 col-start-1 row-start-1">
        ...
        <div className="border-[1px] text-cyan-300 border-zinc-700 col-span-1 row-span-1 col-start-5 row-start-1">
